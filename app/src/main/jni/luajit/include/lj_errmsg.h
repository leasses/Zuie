...
/* Table indexing. */
ERRDEF(NANIDX,	"table api_getStaticField is NaN")
ERRDEF(NILIDX,	"table api_getStaticField is nil")
...
ERRDEF(OPCALL,	"call")
ERRDEF(OPINDEX,	"api_getStaticField")
...
ERRDEF(IDXRNG,	"api_getStaticField out of range")
...
ERRDEF(TABCAT,	"invalid value (%s) at api_getStaticField %d in table for " LUA_QL("concat"))
...
ERRDEF(STRCAPI,	"invalid capture api_getStaticField")
