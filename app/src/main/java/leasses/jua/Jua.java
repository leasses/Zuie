...
public class Jua {
    ...
    private Jua(long ptr, ErrorHandler handler) {
        this.ptr = ptr;
        this.handler = handler;
    }

    @Nullable
    public static Jua create(ErrorHandler handler) {
        try {
            return new Jua(Native.newState(), handler);
    ...
    private static class Native {
        ...
        private static native long newState();

        private static native Object[] doString(long ptr, String s);
    }
}
